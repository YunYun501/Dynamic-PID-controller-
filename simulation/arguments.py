...
def parse_args(argv):
    ...
    p.add_argument("--mode", choices=["position", "velocity", "acceleration", "force"], default="force", help="Control mode")
    p.add_argument("--steps", type=int, default=1000, help="Number of steps to simulate")
